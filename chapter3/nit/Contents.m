...
%      numint3.m -- numerical integration with variable limits, starting
%          with a symbolic expression in x, y, z
%      newnumint2.m -- numerical integration with variable limits, starting
%          with a symbolic expression in x, y
%
% The 1-D routines:
